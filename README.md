> This repository adapts the original codebase from [huggingface/search-and-learn](https://github.com/huggingface/search-and-learn) and is the official implementation of our NeurIPS 2025 paper: [Rethinking Optimal Verification Granularity for Compute-Efficient Test-Time Scaling](https://arxiv.org/abs/2505.11730).

If you find this repository helpful, please cite:

```
@misc{chen2025rethinkingoptimalverificationgranularity,
...
For example usage, refer to `experiment_scripts/example.sh`.

Below is the original README which contains detailed installation and usage guide.
